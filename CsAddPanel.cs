...
namespace ProjectSetup
{
        ...
        //specifies that the command will be responsible for creating any needed transaction icons
        [Transaction(TransactionMode.Manual)]
        //name of command
        public class ProjectSetup : IExternalApplication
        {
           public Result Onstartup(UIControlledApplication application);
            ...
            //Add a new ribbon Panel
                ...
                PushButtonData buttonData = new PushButtonData("Create MEP Views", "Create MEP Views", thisAssemblyPath, "ProjectSetup.Create MEP Views");
                PushButton pushButton = ribbonPanel.AddItem(buttonData) as PushButton;

                //large bitmap
                Uri uriImage = new Uri (@"C:\Users\jay.dunn\Documents\Visual Studio 2013\Projects\ViewCreator\TLC.jpg");
           ...
           public Result OnShutdown(UIControlledApplication application)             
            ...
            public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elementSet)            
                ...
                ///
                /// You needed to actually put the active document in as a UI
                ///
